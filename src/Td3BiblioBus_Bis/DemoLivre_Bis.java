...
public class DemoLivre_Bis {

	public static void main(String[] args) {
		
		Livre_Bis livre1 = new Livre_Bis("Psychopompe", "Amélie Nothomb", "Albin Michel", Genre_Bis.littératureFrancaise);
		Livre_Bis livre2 = new Livre_Bis("Psycho", "Nothomb", "Albin Michel");
		Livre_Bis livre3 = new Livre_Bis("Panaroma", "Lilia Hassaine", "Gallimard");
		Livre_Bis livre4 = new Livre_Bis("Panaroma", "Lilia Hassaine", "Gallimard");
